...
![Showing the position of skills in the explorer](image-1.png)
...
![Use when seeing errors about better-sqlite3 native module...](image.png)
...
![Showing how to use a markdown link](image-2.png)
...
![Showing project and user skills](image-3.png)
...
![Invoking the better-sqlite-rebuild skill](image-4.png)
...
![Showing the description of the skill](image-5.png)
...
![Showing a description deleted from the original diagram](image-7.png)
