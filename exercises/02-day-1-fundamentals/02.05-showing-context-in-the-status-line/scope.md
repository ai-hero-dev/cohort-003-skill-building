...
- What to _do_ when you hit 40% context (context clearing strategies, session management, etc.) — covered in 01.06 (plan-execute-clear loop) and beyond
- Alternative tools or deeper explanations of how ccstatusline works under the hood
- Docker or sandboxing setup

## Teaching Sequence

1. **Brief motivation** — context paranoia is constant; 40% is the dumb zone; Claude Code doesn't show it by default; you need it visible _while you're coding_
...
**Note:** The learner should feel _done_ after this lesson. They walk away with a working status line and are ready to use it as feedback in 01.05 and beyond. No loose threads.
